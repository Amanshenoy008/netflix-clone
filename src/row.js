         ...
         <div  className='flex gap-2 overflow-x-scroll overflow-y-hidden p-2 no-scrollbar ml-3 border-solid border-white'>
          {
            ...
            movies.results.map((d)=>(
              ...
              <img  key={d.id} src={baseurl+(islargerow ? d?.poster_path : d?.backdrop_path)} alt={d.name}   className='cursor-pointer w-1/5 hover:scale-110 hover:ease-in duration-300 p-2 rounded' />
